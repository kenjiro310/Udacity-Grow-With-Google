...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (1) Create a CONSTANT static final key to store the query's URL
    private static final String SEARCH_QUERY_URL_EXTRA = "query";
    // TODO (2) Create a CONSTANT static final key to store the search's raw JSON
    private static final String SEARCH_RESULTS_RAW_JSON = "JSON";
