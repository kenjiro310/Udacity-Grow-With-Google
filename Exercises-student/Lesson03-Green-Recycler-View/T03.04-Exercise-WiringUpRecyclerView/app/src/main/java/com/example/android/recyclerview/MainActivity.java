...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Allows RecyclerView to do some optimization on UI - mainly allowing it to avoid invalidating the whole layout
        // when the adapter contents change
        mNumberList.setHasFixedSize(true);

        // TODO (8) Store a new GreenAdapter in mAdapter and pass it NUM_LIST_ITEMS
        mAdapter = new GreenAdapter(NUM_LIST_ITEMS);

        // TODO (9) Set the GreenAdapter -mAdapter you created on mNumbersList
